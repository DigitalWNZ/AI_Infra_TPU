...
# =============================================================================
#
# This script runs the full MiMo-V2-Flash benchmark on a TPU v6e-16 cluster:
...
#
# Usage:
#   bash benchmark_e2e_v6e16.sh <CLUSTER_NAME> <ZONE> <GCS_BUCKET> <GCS_MODEL_DIR>
#
# Example:
#   bash benchmark_e2e_v6e16.sh a6e-16-wangez us-east5-b 0-wangez jingnw-mimo-v2-flash-us-east5/hf-model
#
# Prerequisites:
...
print_summary() {
    log "============================================="
    log "  MiMo-V2-Flash Benchmark Summary (v6e-16)"
    log "============================================="
    log ""
...
# =============================================================================
main() {
    log "Starting MiMo-V2-Flash benchmark (v6e-16) on ${CLUSTER_NAME}"
